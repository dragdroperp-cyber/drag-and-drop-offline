...
class SyncService {
  ...
  async syncAll(getStoreFunctions = null) {
    ...
    try {
      ...
      let syncOrder = ['categories', 'products', 'customers', 'orders', 'transactions', 'refunds', 'expenses', 'customerTransactions', 'productBatches', 'purchaseOrders', 'planOrders', 'settings'];
