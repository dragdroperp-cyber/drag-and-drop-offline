                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-2xl font-semibold text-slate-900 dark:text-white" title={stat.value}>{stat.value}</p>
                      {stat.secondaryValue && (
                        <p className="text-sm font-medium text-slate-600 dark:text-slate-400 mt-1">Value: {stat.secondaryValue}</p>
                      )}
                    </div>
                  </div>
                </div>
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                ...
                <div className="text-right">
                  <p className="text-xl font-bold text-black dark:text-white">
                    ₹{rangeSales > 0 && filteredOrders.length > 0 ? (rangeSales / filteredOrders.length).toFixed(2) : '0.00'}
                  </p>
                </div>
              </div>
            </div>
