    ...
    >
      <div className="space-y-4 sm:space-y-3 lg:space-y-4 fade-in-up">
        ...
        {showAlertModal && selectedAlert && (
          <div
            className="fixed inset-0 z-[1300] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm sm:px-4 sm:py-6"
            onClick={() => {
          ...
          >
            <div
              className="bg-white dark:bg-slate-800 w-full h-[95%] sm:h-auto sm:max-h-[90vh] sm:max-w-2xl rounded-none sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-slide-up border border-gray-100 dark:border-slate-700"
                  ...
                  {selectedAlert.data.map((item, idx) => {
                    ...
                    return (
                      <div
                        ...
                        className={`group p-4 bg-white dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-2xl transition-all duration-200 hover:shadow-sm ${isExpanded ? 'ring-2 ring-indigo-500 dark:ring-indigo-400 bg-indigo-50/10' : 'hover:border-blue-100 dark:hover:border-blue-700 hover:bg-blue-50/40 dark:hover:bg-slate-700'}`}
                        onClick={() => {
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-[10px] uppercase font-bold tracking-widest text-gray-400 dark:text-slate-500 flex items-center justify-end gap-1">
                              {selectedAlert.type === 'lowStock' ? 'Current Stock' :
                                selectedAlert.type === 'expiring' ? (
                                  ...
                                  'Balance Due'}
                              {(selectedAlert.type === 'pendingPayments' || selectedAlert.type === 'lowStock') && (
                        ...
                        {isExpanded && selectedAlert.type === 'pendingPayments' && (
                          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-slate-700 grid grid-cols-2 gap-3 animate-slide-down">
                            ...
                            <a
                              ...
                              className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-500 text-white font-bold hover:bg-blue-600 transition-colors shadow-sm active:scale-95"
                              onClick={(e) => e.stopPropagation()}
                            >
                        ...
                        {isExpanded && selectedAlert.type === 'lowStock' && (
                          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-slate-700 animate-slide-down">
                            <button
                              ...
                              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition-colors shadow-sm active:scale-95"
                            >
