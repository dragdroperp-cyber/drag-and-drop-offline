  ...
  return (
    <div className={`space-y-6 pb-6 animate-in fade-in duration-500 ${(!isProfileCompleted && !forceHideModal) ? 'blur-sm pointer-events-none select-none overflow-hidden h-screen' : ''}`}>
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Inventory Studio Overview</h1>
            ...
            {recentTransactions.length > 0 ? (
              recentTransactions.map((transaction) => (
                <div
                  ...
                  className="group flex flex-col sm:flex-row sm:items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-all cursor-pointer"
                >
                  ...
                  <div className="text-left sm:text-right mt-3 sm:mt-0 pl-14 sm:pl-0 flex items-center sm:block gap-3">
      ...
      {/* ERP & Quick Operations Header */}
      <div className="flex items-center gap-2 mt-8 mb-4 px-1">
        <Zap className="h-5 w-5 text-amber-500 dark:text-amber-400" />
        <h2 className="text-xs font-black uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">Quick Operations & ERP</h2>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 mb-12">
        <div className="card relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.05] pointer-events-none">
            <div className="absolute -right-20 -top-20 w-80 h-80 rounded-full bg-slate-900 dark:bg-white blur-3xl"></div>
          </div>

          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-8 flex items-center relative z-10">
            ...
            {quickActions.map((action) => {
              ...
              return (
                <button
                  ...
                  className={`group relative overflow-hidden rounded-2xl border border-white/20 p-6 text-left text-white shadow-lg transition-all duration-300 focus:outline-none ${isPlanRestricted ? 'opacity-60 cursor-not-allowed grayscale-[0.5]' : 'hover:-translate-y-1 hover:shadow-2xl'
                    }`}
                ...
                >
                  ...
                  <div className="relative z-10 space-y-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/20 backdrop-blur-md shadow-inner text-white group-hover:scale-110 transition-transform duration-300">
                      <Icon className="h-6 w-6" />
                    </div>
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-black text-lg leading-tight truncate pr-2 tracking-tight">{action.label}</h4>
                        {isPlanRestricted && <Lock className="h-3.5 w-3.5 text-white/70" />}
                      </div>
                      <p className="text-sm text-white/80 font-bold leading-relaxed line-clamp-2">
                        {action.description}
                      </p>
                    </div>
                  </div>
