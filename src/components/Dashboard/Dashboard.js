                ...
                {expiryCountdown ? (
                  expiryCountdown.expired ? (
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                      {[
                        { label: getTranslation('Days', state.currentLanguage), value: expiryCountdown.days },
                        { label: getTranslation('Hours', state.currentLanguage), value: expiryCountdown.hours },
                        { label: getTranslation('Minutes', state.currentLanguage), value: expiryCountdown.minutes },
                        { label: getTranslation('Seconds', state.currentLanguage), value: expiryCountdown.seconds },
                      ].map((segment) => (
                        <div
                          key={segment.label}
                  ...
                  <div className="text-sm font-semibold">
                    {getTranslation('noActivePlan', state.currentLanguage)}
                  </div>
                )}
                {daysRemaining <= 3 && (
                  <button
