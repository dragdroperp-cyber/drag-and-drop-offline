          ...
          <div className="col-span-full">
            <div className="text-center py-20 px-4 rounded-3xl bg-white dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 shadow-sm">
              <div className="w-20 h-20 bg-blue-50 dark:bg-blue-900/20 rounded-full flex items-center justify-center mx-auto mb-6">
                <Warehouse className="h-10 w-10 text-blue-500 dark:text-blue-400" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
                {searchTerm ? 'No suppliers found' : 'Start Building Your Supplier Network'}
              </h3>
              <p className="text-gray-500 dark:text-slate-400 mb-8 max-w-sm mx-auto">
                {searchTerm ? 'Try adjusting your search terms.' : 'Keep track of your suppliers, purchase history, and outstanding balances all in one place.'}
              </p>
              {!searchTerm && (
                <button
                  onClick={() => setShowAddModal(true)}
