...
const SalesOrderHistory = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Stats Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 auto-rows-[1fr]">
        ...
        >
          <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 group-hover:bg-rose-100 dark:group-hover:bg-rose-900/40 transition-colors text-center">
          ...
          <div className="mt-2 text-left">
            ...
            {isLoading ? (
              ...
              <div className="flex items-center gap-2">
                <p className="text-2xl font-semibold text-rose-600" title={formatCurrency(totalRefunds)}>
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
          ...
          <div className="mt-2 text-left">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-blue-600" title={formatCurrency(totalDeliveryCharges)}>
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
          <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 text-center">
            <TrendingUp className="h-5 w-5" />
          </div>
          <div className="mt-2 text-left">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-orange-600" title={formatCurrency(pendingSales)}>
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full text-center">
          <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-violet-50 dark:bg-violet-900/20 text-violet-600 dark:text-violet-400 text-center">
          ...
          <div className="mt-2 text-left">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-violet-600" title={formatCurrency(pendingProfit)}>
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
          <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 text-slate-900 dark:text-slate-100 text-center">
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
          <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 text-center">
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
          <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-center">
            <IndianRupee className="h-5 w-5" />
          </div>
          <div className="mt-2 text-left">
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
          <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-center">
            <IndianRupee className="h-5 w-5" />
          </div>
          <div className="mt-2 text-left">
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
          <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-cyan-50 dark:bg-cyan-900/20 text-cyan-600 dark:text-cyan-400 text-center">
            <IndianRupee className="h-5 w-5" />
          </div>
          <div className="mt-2 text-left">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-cyan-600" title={formatCurrency(codSales)}>
