    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2">
          <div className="relative" ref={exportMenuRef}>
            ...
            {showExportMenu && (
              <div className="fixed sm:absolute inset-x-4 sm:inset-x-auto right-4 sm:right-0 left-4 sm:left-auto mt-2 sm:mt-2 w-auto sm:w-48 bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-[calc(100vh-8rem)] overflow-y-auto">
                <button
                  onClick={() => {
                    exportToCSV();
                    setShowExportMenu(false);
                  }}
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 active:bg-gray-100 flex items-center gap-3 touch-manipulation border-b border-gray-100 last:border-b-0"
                >
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 active:bg-gray-100 flex items-center gap-3 touch-manipulation border-b border-gray-100 last:border-b-0"
                >
                  <FileJson className="h-5 w-5 flex-shrink-0 text-blue-600" />
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 active:bg-gray-100 flex items-center gap-3 touch-manipulation"
                >
                  <Receipt className="h-5 w-5 flex-shrink-0 text-red-600" />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl sm:text-3xl font-bold text-gray-900 leading-none">{filteredOrders.length}</p>
            </div>
            <div className="flex-shrink-0 ml-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-50 rounded-full flex items-center justify-center">
                <IndianRupee className="h-5 w-5 sm:h-6 sm:w-6 text-indigo-600" />
              </div>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl sm:text-3xl font-bold text-gray-900 leading-none">{formatCurrency(totalSales)}</p>
            </div>
            <div className="flex-shrink-0 ml-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-600 mb-2">Cash Sales</p>
              <p className="text-2xl sm:text-3xl font-bold text-gray-900 leading-none">{formatCurrency(cashSales)}</p>
            </div>
            <div className="flex-shrink-0 ml-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-600 mb-2">Online Sales</p>
              <p className="text-2xl sm:text-3xl font-bold text-gray-900 leading-none">{formatCurrency(onlineSales)}</p>
            </div>
            <div className="flex-shrink-0 ml-4">
