...
const SalesOrderHistory = () => {
  ...
  const getPaymentMethodLabel = (method, splitDetails) => {
    ...
    if (m === 'split' && splitDetails) {
      const parts = [];
      if (splitDetails.cashAmount > 0) parts.push(`Cash: ${formatCurrencySmart(splitDetails.cashAmount, state.currencyFormat)}`);
      if (splitDetails.onlineAmount > 0) parts.push(`Online: ${formatCurrencySmart(splitDetails.onlineAmount, state.currencyFormat)}`);
      if (splitDetails.dueAmount > 0) parts.push(`Due: ${formatCurrencySmart(splitDetails.dueAmount, state.currencyFormat)}`);
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end gap-4">
            ...
            <div className="flex-1 flex flex-col">
              <label className="block text-xs sm:text-sm font-bold text-gray-700 dark:text-slate-300 mb-2">Payment Method</label>
            ...
            {/* Date Range Filter */}
            <div className="flex-1 flex flex-col">
              <label className="block text-xs sm:text-sm font-bold text-gray-700 dark:text-slate-300 mb-2">Date Range</label>
              <div className="inline-flex items-center rounded-full border border-slate-200 bg-white/80 p-1 shadow-sm w-full h-[44px] sm:h-[42px]">
                {[
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md">
          ...
          <div className="mt-2">
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1 tracking-wide uppercase">Cash Sales</p>
        ...
        <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md">
          ...
          <div className="mt-2">
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1 tracking-wide uppercase">Online Sales</p>
      ...
      {showOrderDetails && selectedOrder && (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 sm:p-4">
          <div className="bg-white dark:bg-slate-800 w-full h-[95%] sm:h-auto sm:max-w-3xl rounded-none sm:rounded-2xl shadow-xl border dark:border-slate-700/60 flex flex-col overflow-hidden">
