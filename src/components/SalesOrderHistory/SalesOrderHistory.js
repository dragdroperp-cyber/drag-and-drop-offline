  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2">
          <div className="relative" ref={exportMenuRef}>
            ...
            {showExportMenu && (
              <div className="fixed sm:absolute inset-x-4 sm:inset-x-auto right-4 sm:right-0 left-4 sm:left-auto mt-2 sm:mt-2 w-auto sm:w-48 bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-gray-200 dark:border-slate-700 z-50 max-h-[calc(100vh-8rem)] overflow-y-auto">
                <button
                  onClick={() => {
                    exportToCSV();
                    setShowExportMenu(false);
                  }}
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 active:bg-gray-100 dark:active:bg-slate-600 flex items-center gap-3 touch-manipulation border-b border-gray-100 dark:border-slate-700 last:border-b-0"
                >
                  <FileSpreadsheet className="h-5 w-5 flex-shrink-0 text-green-600 dark:text-green-500" />
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 active:bg-gray-100 dark:active:bg-slate-600 flex items-center gap-3 touch-manipulation border-b border-gray-100 dark:border-slate-700 last:border-b-0"
                >
                  <FileJson className="h-5 w-5 flex-shrink-0 text-blue-600 dark:text-blue-500" />
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 active:bg-gray-100 dark:active:bg-slate-600 flex items-center gap-3 touch-manipulation"
                >
                  <Receipt className="h-5 w-5 flex-shrink-0 text-red-600 dark:text-red-500" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
          <div className="flex items-center justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white leading-none truncate" title={filteredOrders.length}>
                {filteredOrders.length}
              </p>
            </div>
            <div className="flex-shrink-0">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-50 dark:bg-indigo-900/30 rounded-2xl flex items-center justify-center">
                <IndianRupee className="h-5 w-5 sm:h-6 sm:w-6 text-indigo-600 dark:text-indigo-400" />
              </div>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
          <div className="flex items-center justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white leading-none truncate" title={formatCurrency(totalSales)}>
                {formatCurrency(totalSales)}
              </p>
            </div>
            <div className="flex-shrink-0">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-50 dark:bg-green-900/30 rounded-2xl flex items-center justify-center">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
          <div className="flex items-center justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white leading-none truncate" title={formatCurrency(cashSales)}>
                {formatCurrency(cashSales)}
              </p>
            </div>
            <div className="flex-shrink-0">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-50 dark:bg-emerald-900/30 rounded-2xl flex items-center justify-center">
                <IndianRupee className="h-5 w-5 sm:h-6 sm:w-6 text-emerald-600 dark:text-emerald-400" />
              </div>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
          <div className="flex items-center justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white leading-none truncate" title={formatCurrency(onlineSales)}>
                {formatCurrency(onlineSales)}
              </p>
            </div>
            <div className="flex-shrink-0">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-50 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center">
              ...
              {paginatedOrders.length > 0 ? (
                paginatedOrders.map((order) => (
                  <tr key={order.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm font-semibold text-gray-900 dark:text-white text-center">
            ...
            <div key={order.id} className="card p-4 hover:shadow-md transition-shadow bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                <div className="min-w-0">
                  ...
                  <p className="text-lg font-black text-gray-900 dark:text-white truncate" title={formatCurrency(order.totalAmount || order.total)}>
                    {formatCurrency(order.totalAmount || order.total)}
                  </p>
                </div>
                <div className="min-w-0">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        ...
                        <div className="sm:col-span-2">
                          ...
                          <div className="grid grid-cols-3 gap-2 sm:gap-3">
                            <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-2.5 sm:p-3">
                              ...
                              <p className="text-base sm:text-lg font-bold text-green-900 dark:text-green-100 break-words">{formatCurrency(cashAmount)}</p>
                            </div>
                            <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-2.5 sm:p-3">
                              ...
                              <p className="text-base sm:text-lg font-bold text-blue-900 dark:text-blue-100 break-words">{formatCurrency(onlineAmount)}</p>
                            </div>
                            <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-2.5 sm:p-3">
                              ...
                              <p className="text-base sm:text-lg font-bold text-red-900 dark:text-red-100 break-words">{formatCurrency(dueAmount)}</p>
                            </div>
                          </div>
                        </div>
                      );
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white break-words">{formatCurrency(selectedOrder.totalAmount || selectedOrder.total)}</p>
                  </div>
                </div>
