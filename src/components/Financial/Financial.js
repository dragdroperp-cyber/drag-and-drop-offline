  ...
  const exportFinancialPDF = async () => {
    try {
      ...
      const metrics = [
        ...
        { label: getTranslation('expenses', state.currentLanguage), value: formatCurrencySmart(totalExpenses, state.currencyFormat) },
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6 space-y-5 custom-scrollbar bg-white dark:bg-slate-900">
                ...
                <div className="p-6 pt-0 pb-8 md:pb-6 bg-white dark:bg-slate-900 flex-shrink-0 -mx-6 -mb-6 mt-4">
                  <button
                    ...
                    className="w-full py-3.5 rounded-lg font-bold text-sm text-white bg-slate-900 hover:opacity-90 transition-all active:scale-[0.98] shadow-sm flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSubmittingExpense ? (
                      <>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-2 flex flex-col gap-2">
                  <button
                    ...
                    className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl transition-all shadow-lg shadow-indigo-200 dark:shadow-none"
                  >
