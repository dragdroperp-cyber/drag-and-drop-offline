...
const Financial = () => {
  ...
  const recentTransactions = filteredOrders
    ...
    .map(order => {
      ...
      return {
        ...
        paymentMethod: normalizePaymentMethod(order.paymentMethod) || order.paymentMethod || 'cash',
  ...
  const recentPurchaseOrders = filteredPurchaseOrders
              ...
              <button
                ...
                type="button"
                  onClick={() => {
                    ...
                    const transactionToShow = t.rawOrder || t;
              ...
              return (
                ...
                >
                  <div className="space-y-1 min-w-0 flex-1">
                    <p className="font-medium text-gray-900 truncate" title={po.supplierName || 'Unknown Supplier'}>{po.supplierName || 'Unknown Supplier'}</p>
