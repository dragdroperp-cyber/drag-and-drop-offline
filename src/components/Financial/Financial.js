...
const Financial = () => {
  ...
  const totalCogs = calculateCogsFromOrderItems(filteredOrders);
  ...
  const exportFinancialPDF = async () => {
    try {
      ...
      const metrics = [
        ...
        { label: normalizeText('Delivery Charges'), value: formatPDFCurrency(totalDeliveryCharges), color: COLORS.primary },
