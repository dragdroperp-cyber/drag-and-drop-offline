    ...
    <div className="space-y-8 fade-in-up">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Track revenue, expenses, and performance</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div key={i} className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-600 mb-2">{card.title}</p>
                <p className="text-2xl sm:text-3xl font-bold text-gray-900 leading-none">₹{card.value.toFixed(2)}</p>
              </div>
              <div className="flex-shrink-0 ml-4">
                <div className={`w-10 h-10 sm:w-12 sm:h-12 bg-${card.color}-50 rounded-full flex items-center justify-center`}>
