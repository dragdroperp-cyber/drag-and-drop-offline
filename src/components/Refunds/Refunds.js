...
const Refunds = () => {
  ...
  const confirmRefund = async () => {
    ...
    try {
      ...
      const creditAmount = totalRefundAmount - Number(cashRefundAmount || 0);
      if (creditAmount > 0 && selectedOrder.customerId) {
        ...
        if (customer) {
          ...
          const newDueAmount = currentDue - creditAmount;
          ...
          const newTransaction = {
            ...
            description: `Credit for product refund (Order: ${orderIdStr})`,
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          {showRefundAmountModal && createPortal(
            <div className="fixed inset-0 z-[2000000] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-300">
              <div className="bg-white dark:bg-slate-900 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-8 duration-300 border border-slate-200 dark:border-slate-800">
                {/* Header */}
                ...
                <div className="p-6 space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-3 rounded-xl font-black uppercase tracking-widest text-sm flex items-center justify-center gap-2 hover:shadow-xl hover:-translate-y-0.5 active:scale-95 transition-all"
                  >
                    Confirm Refund
