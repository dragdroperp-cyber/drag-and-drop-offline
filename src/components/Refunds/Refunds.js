...
const Refunds = () => {
  ...
  const handleProcessRefund = async () => {
    ...
    // Validate batch selection (must select a batch)
                                ...
                                >
                                  ...
                                  <td className="px-4 py-3 text-center">
                                    <input
                                      ...
                                      disabled={item.availableQty === 0 || !(item.batches && item.batches.length > 0)}
                                      className={`w-20 px-2 py-1.5 text-sm border-2 rounded-lg text-center font-semibold ${item.availableQty === 0 || !(item.batches && item.batches.length > 0)
                            ...
                            <div className="space-y-3">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  disabled={item.availableQty === 0 || !(item.batches && item.batches.length > 0)}
                                  className={`w-full px-3 py-2 text-sm border-2 rounded-lg text-center font-semibold ${item.availableQty === 0 || !(item.batches && item.batches.length > 0)
                                    ? 'bg-gray-100 dark:bg-slate-700 cursor-not-allowed text-gray-400 dark:text-slate-500 border-gray-200 dark:border-slate-600'
                                    : 'border-blue-300 dark:border-blue-500/50 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30 text-gray-900 dark:text-white bg-white dark:bg-slate-700'
                                    }`}
                                />
