...
const Refunds = () => {
        ...
        if (syncService.isOnline()) {
          try {
            ...
            syncService.syncAll(getStoreFunctions).then(() => {
              console.log('✅ Refund synced to MongoDB (background)');
            }).catch((syncError) => {
            ...
            console.error('⚠️ Error initiating refund sync:', error);
          }
        } else {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0 pb-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-2xl p-4 sm:p-6 shadow-lg">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-indigo-100 mt-1">Process refunds and manage return requests</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { value: 'orderId', label: 'Order ID', fullLabel: 'Order ID' },
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-all text-sm sm:text-base text-gray-900 placeholder:text-gray-400"
                />
              </div>
                    ...
                    <div
                      ...
                      className={`border-2 rounded-xl p-3 sm:p-4 cursor-pointer transition-all ${
                        hasRefund
                          ...
                          : 'border-gray-200 hover:border-indigo-300 hover:bg-gradient-to-r hover:from-gray-50 hover:to-indigo-50/30'
                      }`}
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                        ...
                        <div className="text-left sm:text-right flex-shrink-0">
                          ...
                          <p className={`text-xs uppercase font-medium ${hasRefund ? 'text-red-600' : 'text-indigo-600'}`}>
          ...
          {selectedOrder && (
            ...
            >
              <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
                {/* Header */}
                <div className="bg-gradient-to-r from-indigo-600 to-blue-600 px-4 sm:px-6 py-4 flex items-center justify-between">
                ...
                <div className="overflow-y-auto flex-1 p-4 sm:p-6">
                  {/* Order Info */}
                  <div className="bg-gradient-to-r from-gray-50 to-indigo-50 rounded-xl p-4 mb-4 border border-gray-200">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="inline-block min-w-full align-middle">
                          <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gradient-to-r from-indigo-50 to-blue-50">
                              <tr>
                                <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wide text-indigo-900">Product</th>
                                <th className="px-4 py-3 text-center text-xs font-bold uppercase tracking-wide text-indigo-900">Ordered</th>
                                <th className="px-4 py-3 text-center text-xs font-bold uppercase tracking-wide text-indigo-900">Refunded</th>
                                <th className="px-4 py-3 text-center text-xs font-bold uppercase tracking-wide text-indigo-900">Available</th>
                                <th className="px-4 py-3 text-right text-xs font-bold uppercase tracking-wide text-indigo-900">Rate</th>
                                <th className="px-4 py-3 text-center text-xs font-bold uppercase tracking-wide text-indigo-900">Refund Qty</th>
                                <th className="px-4 py-3 text-right text-xs font-bold uppercase tracking-wide text-indigo-900">Total</th>
                              </tr>
                            </thead>
                                    ...
                                    <input
                                      ...
                                      className={`w-20 px-2 py-1.5 text-sm border-2 rounded-lg text-center font-semibold ${
                                        item.availableQty === 0
                                          ...
                                          : 'border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/30 text-gray-900'
                                      }`}
                                    />
                                  </td>
                      ...
                      <div className="mt-4 sm:mt-6 space-y-4">
                        <div className="flex justify-end">
                          <div className="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-xl p-4 sm:p-6 shadow-lg w-full sm:w-auto">
                            <p className="text-xs sm:text-sm text-indigo-100 mb-1 font-medium">Total Refund Amount</p>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-all text-sm sm:text-base text-gray-900 placeholder:text-gray-400"
                          />
                        </div>
                          ...
                          <button
                            ...
                            className={`w-full sm:w-auto px-6 py-3 rounded-xl font-bold transition-all ${
                              isProcessing || totalRefundAmount === 0
                                ...
                                : 'bg-gradient-to-r from-indigo-600 to-blue-600 text-white shadow-lg hover:shadow-xl active:scale-95'
                            }`}
                          >
                            {isProcessing ? (
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            ...
            <div className="hidden sm:block overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gradient-to-r from-indigo-50 to-blue-50">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wide text-indigo-900">Refund ID</th>
                    <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wide text-indigo-900">Order ID</th>
                    <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wide text-indigo-900">Customer</th>
                    <th className="px-4 py-3 text-right text-xs font-bold uppercase tracking-wide text-indigo-900">Amount</th>
                    <th className="px-4 py-3 text-center text-xs font-bold uppercase tracking-wide text-indigo-900">Items</th>
                    <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wide text-indigo-900">Date</th>
                    <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wide text-indigo-900">Refunded By</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                  {paginatedRefunds.length > 0 ? (
                    paginatedRefunds.map((refund) => (
                      <tr key={refund.id} className="hover:bg-indigo-50/30 transition-colors">
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700 text-center">
                          <span className="bg-indigo-100 text-indigo-800 px-2 py-1 rounded-lg font-semibold text-xs">
                            {refund.itemsCount || 0}
                          </span>
                        </td>
                        <td className="px-4 py-3 text-sm text-gray-700">
                  ...
                  <div key={refund.id} className="p-4 hover:bg-gray-50">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-indigo-600">{formatCurrency(refund.totalRefundAmount)}</p>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl font-bold hover:shadow-lg active:scale-95 transition-all"
              >
                Close
              </button>
            </div>
