                  ...
                  <div className="bg-gradient-to-r from-gray-50 to-slate-50 dark:from-slate-700/50 dark:to-slate-800/50 rounded-xl p-4 mb-4 border border-gray-200 dark:border-slate-700">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-indigo-600 dark:text-indigo-400 text-lg">{formatCurrency(selectedOrder.totalAmount || selectedOrder.total)}</p>
                      </div>
                    </div>
                  </div>
                        ...
                        {refundItems.map((item) => (
                          ...
                          >
                            <div className="flex items-start justify-between mb-3">
                              ...
                              <span className="text-xs font-semibold text-[#2f3c7e] dark:text-blue-400 bg-blue-50 dark:bg-slate-700/50 px-2 py-1 rounded">
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-3 text-xs">
                              ...
                              <div>
                                ...
                                <p className="font-bold text-indigo-600 dark:text-indigo-400">{formatCurrency(item.refundQty * item.rate)}</p>
                              </div>
                            </div>
                  ...
                  <div key={refund.id} className="p-4 hover:bg-gray-50 dark:hover:bg-slate-700/50">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-rose-600">{formatCurrency(refund.totalRefundAmount)}</p>
