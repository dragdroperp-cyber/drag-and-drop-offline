                            ...
                            <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                              {refundItems.map((item, index) => (
                                ...
                                >
                                  ...
                                  <td className="px-4 py-3 text-sm text-gray-700 dark:text-slate-300 text-center">
                                    {item.refundedQty} <span className="text-gray-500 dark:text-slate-500 text-xs">{item.unit}</span>
                                  </td>
                                  <td className="px-4 py-3 text-sm font-bold text-blue-600 dark:text-blue-400 text-center">
                                    {item.availableQty} <span className="text-gray-500 dark:text-slate-500 text-xs font-normal">{item.unit}</span>
                                  </td>
                                  ...
                                  <td className="px-4 py-3 text-sm font-bold text-blue-600 dark:text-blue-400 text-right">
                          ...
                          >
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-3 text-xs">
                              ...
                              <div>
                                ...
                                <p className="font-semibold text-gray-900 dark:text-white">{item.refundedQty} {item.unit}</p>
                              </div>
                              <div>
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                <thead className="bg-gradient-to-r from-blue-50 to-slate-50 dark:from-slate-700/50 dark:to-slate-800/50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wide text-slate-700 dark:text-slate-300">Refunded By</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                  ...
                  <div key={refund.id} className="p-4 hover:bg-gray-50 dark:hover:bg-slate-700/50">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-blue-600 dark:text-blue-400">{formatCurrency(refund.totalRefundAmount)}</p>
