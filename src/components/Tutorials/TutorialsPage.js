                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500 dark:text-slate-400">Master every feature of Inventory Studio</p>
                            </div>
                        </div>
                    ...
                    <div className="mb-8 sm:mb-12 relative overflow-hidden rounded-none sm:rounded-3xl bg-indigo-600 p-6 sm:p-12 text-white">
                        <div className="relative z-10 max-w-2xl">
                            ...
                            <p className="text-indigo-100 text-lg mb-8 leading-relaxed">
                                Take a complete tour of Inventory Studio and learn the easiest workflow to grow your sales and manage inventory like a pro.
                            </p>
                            <button
                                onClick={() => window.open('https://www.youtube.com/@DragAndDrop-n2g', '_blank')}
