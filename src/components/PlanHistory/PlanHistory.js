                    ...
                    >
                        ...
                        >
                            ...
                            <div className="p-4 border-t dark:border-slate-700 bg-gray-50/50 dark:bg-slate-800/50 backdrop-blur-sm">
                                <button
                                    onClick={() => setSelectedPlan(null)}
                                    className="w-full py-4 rounded-2xl bg-[#0f172a] dark:bg-slate-700 text-white font-bold shadow-lg hover:bg-[#1e293b] dark:hover:bg-slate-600 transition-all flex items-center justify-center gap-2 active:scale-95 group"
                                >
