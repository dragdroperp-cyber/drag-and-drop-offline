        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xl sm:text-2xl font-black text-gray-900 dark:text-white break-all" title={totalOrders}>{totalOrders}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xl sm:text-2xl font-black text-gray-900 dark:text-white break-all" title={pendingOrders}>{pendingOrders}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xl sm:text-2xl font-black text-gray-900 dark:text-white break-all" title={completedOrders}>{completedOrders}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xl sm:text-2xl font-black text-rose-600 whitespace-nowrap overflow-x-auto scrollbar-hide" title={formatCurrency(totalValue)}>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700 bg-white dark:bg-slate-800">
              {paginatedOrders.map((order) => (
                <tr key={order.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                  ...
                  <td className="px-4 py-4 text-right font-semibold text-rose-600 align-top whitespace-nowrap">
            ...
            <div className="mb-6 p-4 rounded-xl bg-gray-50 dark:bg-slate-700/50">
              ...
              {deleteConfirm.orderInfo?.total > 0 && (
                <p className="text-xs mt-2 text-gray-500 dark:text-slate-400">
                  Order Total: <span className="font-semibold text-gray-900 dark:text-white break-all">{formatCurrency(deleteConfirm.orderInfo.total)}</span>
                </p>
              )}
