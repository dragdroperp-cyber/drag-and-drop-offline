...
import { X, Package, Camera, QrCode, Plus } from 'lucide-react';
      ...
      >
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-slate-700 sticky top-0 bg-white dark:bg-slate-800 rounded-t-xl z-10 transition-colors">
          <div className="flex items-center">
            ...
            <h2 id="edit-product-title" className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Edit Product</h2>
          </div>
          <button
            onClick={onClose}
            data-modal-close
