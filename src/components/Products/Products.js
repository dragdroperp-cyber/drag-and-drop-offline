...
const Products = () => {
  ...
  const openAddProductModal = (barcode = '') => {
    if (isPlanExpired(state)) {
      if (window.showToast) {
        window.showToast('Your plan has expired. Please upgrade your plan to add new products.', 'warning', 8000);
      }
      return;
    }
    if (atProductLimit) {
  ...
  const exportProductsPDF = async (withBatches = false) => {
    try {
      ...
      const metrics = [
        ...
        { label: 'Total Value', value: formatCurrencySmart(totalValue, state.currencyFormat) }
      ];
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md">
              ...
              <div className="mt-2">
                <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1 tracking-wide uppercase">Expiring Soon</p>
          ...
          {showAddBatchModal && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
              <div className="bg-white dark:bg-slate-800 rounded-none sm:rounded-2xl shadow-xl max-w-2xl w-full h-full sm:h-auto sm:max-h-[90vh] overflow-y-auto" data-batch-modal>
                <div className="sticky top-0 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 px-6 py-4 rounded-t-2xl flex items-center justify-between z-10">
          ...
          {showBatchDetailsModal && selectedProduct && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
              <div className="bg-white rounded-none sm:rounded-2xl shadow-xl max-w-4xl w-full h-full sm:h-auto sm:max-h-[90vh] overflow-y-auto">
