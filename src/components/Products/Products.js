    ...
    >
      <div className="space-y-4 sm:space-y-6 pb-6">
        ...
        <>
          ...
          {showAddBatchModal && (
            <div
              className={`fixed inset-0 bg-slate-900/40 z-50 flex items-end md:items-center justify-center transition-opacity duration-300 ${isClosingBatchModal ? 'opacity-0' : 'animate-fadeIn'}`}
                        ...
                        <div className="md:hidden space-y-4">
                          {selectedProduct.batches.map((batch, index) => {
                            ...
                            return (
                              ...
                              <div key={batch.id || index} className={`${isEditing
                                ? 'bg-blue-50 dark:bg-blue-900/20'
                                : 'bg-gray-50 dark:bg-slate-700/30'
                                } border border-gray-200 dark:border-slate-700 rounded-xl p-4 shadow-sm`}>
                                {isEditing ? (
                                  <div className="space-y-4">
                                    <div className="flex justify-between items-center">
