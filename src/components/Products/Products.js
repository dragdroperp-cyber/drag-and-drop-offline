      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 pb-6 border-b border-gray-200 dark:border-slate-700">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="btn-secondary flex items-center text-sm disabled:opacity-50 disabled:cursor-not-allowed dark:text-slate-200"
          ...
          <button
            ...
            className="btn-secondary flex items-center text-sm dark:text-slate-200"
          >
            <Layers className="h-4 w-4 mr-0 sm:mr-2" />
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="w-full sm:w-48 relative">
            ...
            <select
              ...
              className="block w-full pl-10 pr-10 py-3 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl text-sm font-medium text-gray-700 dark:text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all shadow-sm outline-none appearance-none cursor-pointer"
            >
