  ...
  const handleBatchSubmit = async () => {
    ...
    try {
      ...
      const newBatch = {
        ...
        unitPrice: parseFloat(costPrice), // Legacy field
        sellingUnitPrice: parseFloat(sellingUnitPrice),
        sellingPrice: parseFloat(sellingUnitPrice), // Legacy field
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setNewBatchData({ ...newBatchData, quantity: val });
                            }}
                            className="w-full rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-4 py-3 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900/30 transition"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const val = e.target.value.replace(/[^0-9.]/g, '');
                              setNewBatchData({ ...newBatchData, costPrice: val });
                            }}
                            className="w-full rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-4 py-3 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900/30 transition"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const val = e.target.value.replace(/[^0-9.]/g, '');
                              setNewBatchData({ ...newBatchData, sellingUnitPrice: val });
                            }}
                            className="w-full rounded-xl border border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white px-4 py-3 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900/30 transition"
                          />
                        </div>
