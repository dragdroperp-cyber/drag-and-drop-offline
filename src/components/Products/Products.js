                                  ...
                                  <>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm mb-3">
                                      <div className="bg-white dark:bg-slate-800 p-2 rounded-lg border border-gray-100 dark:border-slate-700">
                                        ...
                                        <p className="font-semibold text-gray-900 dark:text-white">₹{batch.costPrice ? batch.costPrice.toFixed(2) : '0.00'}</p>
                                      </div>
                                      <div className="bg-white dark:bg-slate-800 p-2 rounded-lg border border-gray-100 dark:border-slate-700">
                                        <p className="text-xs text-gray-500 dark:text-slate-400">Selling Price</p>
                                        <p className="font-semibold text-gray-900 dark:text-white">₹{batch.sellingUnitPrice ? batch.sellingUnitPrice.toFixed(2) : '0.00'}</p>
                                      </div>
                                    </div>
