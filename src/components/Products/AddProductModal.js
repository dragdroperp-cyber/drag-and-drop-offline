...
const AddProductModal = ({
  ...
  const handleChange = (e) => {
    ...
    const numericFields = ['lowStockLevel', 'wholesalePrice', 'wholesaleMOQ', 'discountPrice', 'gstPercent'];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
              ...
              <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-1">Best Seller</span>
                  <label className="flex items-center gap-3 h-[48px] px-4 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg cursor-pointer hover:border-indigo-500 transition-all select-none">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-[11px] font-bold text-gray-700 dark:text-gray-300 uppercase tracking-tight">Featured</span>
                  </label>
                </div>
                ...
                {/* Sale Price (Web) */}
                <div className="space-y-1">
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-1">Sale Price</span>
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className="block w-full h-[48px] px-4 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg text-sm font-bold text-gray-900 dark:text-white focus:border-indigo-500 outline-none transition-all"
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  <div className="md:col-span-1">
                    ...
                    <div className="w-24 h-24 md:w-full md:aspect-square bg-slate-50 dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 flex items-center justify-center overflow-hidden relative shadow-inner mt-2">
                      {/* Dynamic image preview if we had a state, but here we use simple inputs */}
              ...
              <div className="p-6 border-t border-gray-50 dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0">
                <button
                  onClick={() => {
                    ...
                    const imgUrl = document.getElementById('new-cat-image').value;
