...
const AddProductModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4 transition-opacity">
      <div
        ref={containerRef}
        className="bg-white dark:bg-slate-800 rounded-xl shadow-xl w-full max-w-2xl max-h-[95vh] overflow-y-auto transition-all"
        role="dialog"
        aria-modal="true"
