...
import { Shield, Sparkles, TrendingUp, ArrowRight, CreditCard } from 'lucide-react';
        ...
        <section className="flex flex-1 items-start justify-center">
          <div className="w-full max-w-md rounded-3xl border border-sky-100 bg-white/95 p-10 shadow-[0_35px_90px_-45px_rgba(15,23,42,0.4)] backdrop-blur login-fade-up login-delay-6">
            ...
            <button
              ...
              className="mt-6 w-full rounded-xl border border-orange-200 bg-gradient-to-r from-orange-50 to-orange-100 py-3 px-4 text-sm font-semibold text-orange-700 shadow-sm transition hover:from-orange-100 hover:to-orange-200 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <p className="mt-2 text-xs text-center text-slate-500">
              For Razorpay team to test the website
            </p>
