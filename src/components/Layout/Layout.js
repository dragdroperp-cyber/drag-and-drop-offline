  ...
  return (
    <div className="flex h-screen text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      {isLoadingAccess === true && (
        <div className="fixed inset-0 z-50 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center">
          <div className="text-center">
            {/* Simple animated logo */}
            <div className="mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-white dark:bg-slate-800 rounded-full shadow-lg mb-6">
                <div className="w-8 h-8 border-4 border-blue-500 dark:border-blue-400 border-t-transparent rounded-full animate-spin"></div>
              </div>
              <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Drag & Drop</h1>
              <div className="w-16 h-0.5 bg-blue-500 dark:bg-blue-400 rounded-full mx-auto"></div>
            </div>

            {/* Clean loading message */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-700 dark:text-slate-200 mb-3">
            ...
            <div className="flex justify-center space-x-2">
              ...
              <div className="w-3 h-3 bg-blue-500 dark:bg-blue-400 rounded-full animate-bounce delay-100"></div>
              <div className="w-3 h-3 bg-blue-500 dark:bg-blue-400 rounded-full animate-bounce delay-200"></div>
            </div>
          </div>
        </div>
      )}
