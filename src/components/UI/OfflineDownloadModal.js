...
const OfflineDownloadModal = ({
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 animate-fadeIn">
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-md w-full p-6 border border-gray-200 dark:border-slate-700 animate-slideUp">
                {/* Header */}
                ...
                {/* Content */}
                <div className="mb-6">
                    <div className="flex items-start gap-3 p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-900/30 rounded-xl mb-4">
                    ...
                    {missingResources && missingResources.length > 0 && (
                        <div className="mb-4">
                            ...
                            <div className="max-h-32 overflow-y-auto bg-gray-50 dark:bg-slate-900/50 rounded-lg p-3 space-y-1">
