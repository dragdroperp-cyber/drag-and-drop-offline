                    ...
                    >
                        ...
                        <div className="flex justify-between items-start border-b-2 pb-6 mb-8" style={{ borderColor: config.themeColor }}>
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold uppercase tracking-tight" style={{ color: config.themeColor }}>GROCERY STUDIO</h2>
                                    {config.showAddress && (
                        ...
                        <div className="mt-12 pt-4 border-t border-slate-100 flex justify-between items-center">
                            <div className="text-[8px] font-bold text-slate-300 uppercase tracking-widest">Generated via Grocery Studio Cloud</div>
