...
const Upgrade = () => {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900"><Loader className="animate-spin h-10 w-10 text-[#0f172a]" /></div>;
  }
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute bottom-4 right-4 z-10">
                      <span className="text-sm font-bold text-[#0f172a] dark:text-blue-400 group-hover:underline flex items-center gap-1">
      ...
      {checkoutPlan && (
        ...
        >
          <div
            ...
            className="fixed inset-0 sm:relative sm:inset-auto bg-white dark:bg-slate-800 w-full sm:max-w-2xl h-full sm:h-auto sm:max-h-[90vh] rounded-none sm:rounded-[2rem] shadow-2xl flex flex-col overflow-hidden dark:border dark:border-slate-700"
            ...
            <div className="p-4 border-t dark:border-slate-700 bg-gray-50/50 dark:bg-slate-800/50 backdrop-blur-sm">
              <button
                ...
                className={`w-full py-4 rounded-2xl font-bold shadow-lg transition-all flex items-center justify-center gap-2 ${checkoutPlan.current && checkoutPlan.planType !== 'mini'
                  ...
                  : 'bg-[#0f172a] dark:bg-blue-600 text-white rounded-2xl font-bold shadow-lg hover:bg-[#1e293b] dark:hover:bg-blue-700 transition-all'
                  }`}
              >
                {upgradingPlanId ? (
