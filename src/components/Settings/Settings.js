  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      <div className="text-center">
        ...
        <p className="text-xs text-gray-400 mt-1">Service Worker: {swStatus}</p>
        ...
        <button
          ...
          className="mt-2 px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded hover:bg-gray-200 transition-colors"
        >
          Check for Updates
        </button>

        <p className="text-xs text-gray-400 mt-2">© 2024 Grocery ERP. All rights reserved.</p>
      </div>
    </div>
  );
};
