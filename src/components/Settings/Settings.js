        ...
        {!isEditing ? (
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-1 text-white text-sm rounded-lg transition-colors disabled:opacity-60 ${isPlanExpired(state) ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 dark:bg-indigo-600 hover:bg-blue-700 dark:hover:bg-indigo-700'}`}
            >
