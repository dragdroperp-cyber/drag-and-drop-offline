...
import { Plus, Edit, Trash2, Search, X, Save, AlertCircle, Printer } from 'lucide-react';
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            disabled={!!initialData} // pCode usually shouldn't change for consistency, or maybe allow it?
                    ...
                    <div className="flex justify-end gap-3 mt-6">
                        ...
                        <button
                            type="submit"
                            className="px-4 py-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-100 rounded-lg shadow-lg hover:shadow-xl transition-all flex items-center gap-2"
                        >
...
const DProducts = () => {
    ...
    const handleDeleteProduct = (id) => {
        if (window.confirm('Are you sure you want to delete this product?')) {
            dispatch({ type: ActionTypes.DELETE_D_PRODUCT, payload: id });
        }
    };
    ...
    return (
        <div className="space-y-6 pb-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Direct Products (D-Products)</h1>
                    <p className="text-slate-500 dark:text-slate-400">Manage non-inventory products and services</p>
                </div>
                <button
                    onClick={() => setIsAddModalOpen(true)}
                    className="flex items-center justify-center gap-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-100 px-5 py-2.5 rounded-xl shadow-lg hover:shadow-xl transition-all font-medium"
                >
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all shadow-sm"
                />
            </div>
                                ...
                                <tr>
                                    <td colSpan="5" className="px-6 py-12 text-center text-slate-500 dark:text-slate-400">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <p className="text-lg font-medium">No D-Products found</p>
