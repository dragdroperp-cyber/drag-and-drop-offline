                ...
                <div className="max-w-4xl mx-auto flex justify-center">
                    {step === 1 ? (
                        ...
                        <div className="w-full flex justify-center">
                            <button
                                onClick={handlePrint}
                                className="w-full max-w-md bg-slate-900 dark:bg-white text-white dark:text-slate-900 py-2.5 px-12 rounded-xl font-bold text-sm sm:text-base shadow-2xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 sm:gap-3"
                            >
