...
const GstPage = () => {
    ...
    const exportGstPDF = async () => {
        try {
            ...
            pdf.text('Inventory Studio', logoX + logoSize + 4, logoY + 9);
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                        Information is for general guidance only. Inventory Studio does not provide professional tax advice. Please consult a Chartered Accountant (CA) for official compliance.
                                    </p>
                                </div>
                            </div>
                        </div>
