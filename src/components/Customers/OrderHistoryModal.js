  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-white dark:bg-slate-800 rounded-none sm:rounded-2xl shadow-2xl w-full h-auto max-h-[95vh] sm:h-auto sm:max-w-3xl sm:max-h-[90vh] flex flex-col overflow-hidden transition-colors relative"
                  ...
                  {orderItems.length > 0 && (
                    <div className="px-4 sm:px-5 pb-4 space-y-3">
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
                        ...
                        <div className="rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-3 py-2.5 min-w-0">
                          <p className="text-sm sm:text-base text-purple-600 dark:text-purple-400 uppercase font-black tracking-widest mb-1 truncate">{getTranslation('tax', state.currentLanguage)} ({(breakdown.taxPercent || 0).toFixed(0)}%)</p>
                          <p className="text-base sm:text-lg font-black text-purple-600 dark:text-purple-400 whitespace-nowrap overflow-x-auto scrollbar-hide font-black" title={`+ ${formatCurrency(breakdown.taxAmount)}`}>
