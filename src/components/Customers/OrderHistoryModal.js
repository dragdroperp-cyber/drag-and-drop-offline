          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-2 lg:flex lg:flex-wrap gap-2 text-[10px] sm:text-xs text-gray-500">
              <span className="inline-flex items-center gap-1.5 rounded-lg bg-gray-50 dark:bg-slate-700/50 px-2 py-1.5 text-gray-600 dark:text-slate-300 border border-gray-100 dark:border-slate-700 min-w-0">
                ...
                <span className="truncate">Subtotal {formatCurrency(totalSubtotal)}</span>
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-lg bg-gray-50 dark:bg-slate-700/50 px-2 py-1.5 text-gray-600 dark:text-slate-300 border border-gray-100 dark:border-slate-700 min-w-0">
                <span className="h-2 w-2 rounded-full bg-emerald-500 flex-shrink-0" />
                <span className="truncate">Disc {formatCurrency(roundAmount(totalDiscount))}</span>
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-lg bg-gray-50 dark:bg-slate-700/50 px-2 py-1.5 text-gray-600 dark:text-slate-300 border border-gray-100 dark:border-slate-700 min-w-0">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 px-2 py-1.5 text-indigo-700 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-900/30 min-w-0">
                        ...
                        <div className="px-4 sm:px-5 pb-3">
                          ...
                          <div className="grid grid-cols-3 gap-2 sm:gap-3">
                            <div className="bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-900/30 rounded-xl p-2 sm:p-3 min-w-0">
                              ...
                              <p className="text-sm sm:text-lg font-black text-green-700 dark:text-green-300 truncate text-center" title={formatCurrency(cashAmount)}>{formatCurrency(cashAmount)}</p>
                            </div>
                            <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 rounded-xl p-2 sm:p-3 min-w-0">
                              ...
                              <p className="text-sm sm:text-lg font-black text-blue-700 dark:text-blue-300 truncate text-center" title={formatCurrency(onlineAmount)}>{formatCurrency(onlineAmount)}</p>
                            </div>
                            <div className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-xl p-2 sm:p-3 min-w-0">
                              ...
                              <div className="text-sm sm:text-lg font-black text-red-700 dark:text-red-300 flex items-center justify-center gap-1.5 truncate">
                                {(order.allPaymentClear && dueAmount > 0) ? (
                                  ...
                                  <span title={formatCurrency(order.allPaymentClear ? 0 : dueAmount)}>{formatCurrency(order.allPaymentClear ? 0 : dueAmount)}</span>
                                )}
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="px-4 sm:px-5 pb-4 space-y-3">
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
                        <div className="rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-3 py-2.5 min-w-0">
                          ...
                          <p className="text-xs sm:text-sm font-black text-gray-900 dark:text-white truncate" title={formatCurrency(breakdown.subtotal)}>{formatCurrency(breakdown.subtotal)}</p>
                        </div>
                        <div className="rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-3 py-2.5 min-w-0">
                          <p className="text-[9px] sm:text-xs text-emerald-600 dark:text-emerald-400 uppercase font-black tracking-widest mb-1 truncate">Disc ({(breakdown.discountPercent || 0).toFixed(0)}%)</p>
                          <p className="text-xs sm:text-sm font-black text-emerald-600 dark:text-emerald-400 truncate" title={`- ${formatCurrency(breakdown.discountAmount)}`}>
                        ...
                        <div className="rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-3 py-2.5 min-w-0">
                          ...
                          <p className="text-xs sm:text-sm font-black text-purple-600 dark:text-purple-400 truncate" title={`+ ${formatCurrency(breakdown.taxAmount)}`}>
                            + {formatCurrency(breakdown.taxAmount)}
                          </p>
                        </div>
                        <div className="rounded-xl bg-indigo-50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-900/30 px-3 py-2.5 min-w-0">
                          <p className="text-[9px] sm:text-xs text-indigo-700 dark:text-indigo-300 uppercase font-black tracking-widest mb-1 truncate">Total</p>
                          <p className="text-xs sm:text-sm font-black text-indigo-700 dark:text-indigo-300 truncate" title={formatCurrency(breakdown.netTotal)}>{formatCurrency(breakdown.netTotal)}</p>
                        </div>
                      </div>
