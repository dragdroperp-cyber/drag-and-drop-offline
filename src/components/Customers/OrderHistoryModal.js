      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 border-b border-gray-200 dark:border-slate-700 px-4 sm:px-6 py-4 flex-shrink-0">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs sm:text-sm text-gray-500 dark:text-slate-400 mb-3 break-words line-clamp-1" title={`${customer?.name || 'Customer'} • ${filteredOrders.length} ${getTranslation('orders', state.currentLanguage)} • ${getTranslation('netPaid', state.currentLanguage)} ${formatCurrency(totalSpend)}`}>
                    ...
                    if (paymentMethod === 'split') {
                      ...
                      return (
                        <div className="px-4 sm:px-5 pb-3">
                          <p className="text-[10px] sm:text-sm text-gray-500 dark:text-slate-400 mb-2 font-bold uppercase tracking-wider">{getTranslation('paymentBreakdown', state.currentLanguage)}</p>
                          <div className="grid grid-cols-3 gap-2 sm:gap-3">
                            <div className="bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-900/30 rounded-xl p-2 sm:p-3 min-w-0">
                              <p className="text-[9px] sm:text-xs text-green-600 dark:text-green-400 font-bold uppercase mb-0.5 truncate text-center">{getTranslation('cash', state.currentLanguage)}</p>
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 rounded-xl p-2 sm:p-3 min-w-0">
                              <p className="text-[9px] sm:text-xs text-blue-600 dark:text-blue-400 font-bold uppercase mb-0.5 truncate text-center">{getTranslation('online', state.currentLanguage)}</p>
                            ...
                            <div className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-xl p-2 sm:p-3 min-w-0">
                              <p className="text-[9px] sm:text-xs text-red-600 dark:text-red-400 font-bold uppercase mb-0.5 truncate text-center">{getTranslation('due', state.currentLanguage)}</p>
                    ...
                    <div className="px-4 sm:px-5 pb-4 space-y-3">
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
                        <div className="rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-3 py-2.5 min-w-0">
                          <p className="text-[9px] sm:text-xs text-gray-500 dark:text-slate-400 uppercase font-black tracking-widest mb-1 truncate">{getTranslation('subtotal', state.currentLanguage)}</p>
                        ...
                        <div className="rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-3 py-2.5 min-w-0">
                          <p className="text-[9px] sm:text-xs text-rose-600 dark:text-rose-400 uppercase font-black tracking-widest mb-1 truncate">{getTranslation('disc', state.currentLanguage)} ({(breakdown.discountPercent || 0).toFixed(0)}%)</p>
                        ...
                        <div className="rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-3 py-2.5 min-w-0">
                          <p className="text-[9px] sm:text-xs text-purple-600 dark:text-purple-400 uppercase font-black tracking-widest mb-1 truncate">{getTranslation('tax', state.currentLanguage)} ({(breakdown.taxPercent || 0).toFixed(0)}%)</p>
                        ...
                        <div className="rounded-xl bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-900/30 px-3 py-2.5 min-w-0">
                          <p className="text-[9px] sm:text-xs text-emerald-700 dark:text-emerald-300 uppercase font-black tracking-widest mb-1 truncate">{getTranslation('total', state.currentLanguage)}</p>
