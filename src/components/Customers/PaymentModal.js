...
const PaymentModal = ({ customer, onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 p-0 sm:p-4 transition-opacity">
      <div className="bg-white dark:bg-slate-800 rounded-none sm:rounded-2xl shadow-[0_25px_80px_-12px_rgba(0,0,0,0.3)] w-full max-w-lg border border-gray-200/50 dark:border-slate-700 h-full sm:h-auto sm:my-auto sm:max-h-[95vh] flex flex-col transition-all">
        {/* Header */}
