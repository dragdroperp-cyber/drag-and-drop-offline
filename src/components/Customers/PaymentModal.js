        ...
        <div className="p-6 space-y-6">
          ...
          <div className="text-center">
            ...
            <div className={`text-3xl font-bold tracking-tight ${currentBalance > 0 ? 'text-rose-600 dark:text-rose-500' :
              ...
              ₹{Number.isInteger(absBalance) ? absBalance : absBalance.toFixed(2)}
              ...
              <div className="flex gap-2 justify-center">
                {getQuickAmounts().map((option, index) => (
                  <button
                    key={index}
                    type="button"
                    onClick={() => setAmount(Number.isInteger(option.amount) ? option.amount.toString() : option.amount.toFixed(2))}
