          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className={`block w-full px-4 py-3 bg-white dark:bg-slate-900 border ${error ? 'border-red-500 ring-4 ring-red-500/10' : 'border-gray-200 dark:border-slate-700'} rounded-lg text-sm font-medium text-gray-900 dark:text-white focus:border-indigo-500 outline-none transition-all`}
                autoFocus
              />
              {error && (
            ...
            {/* Examples */}
            <div className="bg-slate-50 dark:bg-slate-800/30 rounded-xl p-4 border border-gray-100 dark:border-slate-800">
            ...
            <div className="flex gap-3 pt-2 pb-2">
              <button
                type="button"
                onClick={handleCloseModal}
                className="flex-1 py-3 px-4 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-lg text-sm font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-800 transition-all active:scale-[0.98]"
                disabled={isSaving}
              >
                Cancel
              </button>
