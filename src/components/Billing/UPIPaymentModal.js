...
const UPIPaymentModal = ({ bill, onClose, onPaymentReceived, onSaveUPIId }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl border dark:border-slate-700/60 transition-colors">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 dark:bg-slate-800/50 rounded-xl p-4 border border-gray-100 dark:border-slate-700/50">
            ...
            <div className="space-y-2.5 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{new Date(bill.date).toLocaleDateString()}</span>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="flex-1 px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 transition-all flex items-center justify-center text-sm"
              >
              ...
              <button
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-indigo-600 dark:bg-indigo-500 text-white font-semibold shadow-lg shadow-indigo-500/20 hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-all flex items-center justify-center text-sm"
              >
          ...
          <div className="text-center pt-2">
            {paymentStatus === 'pending' && (
              <div className="flex items-center justify-center space-x-2 text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/10 py-2 rounded-lg border border-orange-100 dark:border-orange-900/20">
                <Clock className="h-5 w-5 animate-pulse" />
                <span className="font-bold text-sm">Waiting for Payment Confirmation...</span>
              </div>
            )}
