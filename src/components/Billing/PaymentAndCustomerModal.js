  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
        <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-[0_20px_60px_-12px_rgba(0,0,0,0.25)] w-full max-w-md border border-slate-200/60 dark:border-slate-700/60 my-auto max-h-[95vh] flex flex-col">
          {/* Fixed Header */}
          <div className="flex items-center justify-between p-6 pb-4 flex-shrink-0 border-b border-slate-200/60 dark:border-slate-700/60">
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Total: ₹{total.toFixed(2)}</p>
            </div>
            <button
              onClick={onClose}
