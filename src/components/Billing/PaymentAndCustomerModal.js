        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0" noValidate>
            ...
            <div className="p-6 pt-0 pb-8 md:pb-6 flex gap-3">
              ...
              <button
                type="submit"
                className="flex-[2] py-3.5 rounded-lg font-bold text-sm text-white bg-gray-900 dark:bg-slate-900 hover:opacity-90 transition-all active:scale-[0.98] shadow-sm"
              >
          ...
          <div className="bg-white dark:bg-slate-900 w-full max-w-lg rounded-xl shadow-xl overflow-hidden" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 pt-0">
              <button
                ...
                className="w-full py-3 rounded-lg font-bold text-xs text-gray-500 bg-gray-100 dark:bg-slate-800 uppercase tracking-widest hover:bg-gray-200 transition-all font-bold"
              >
