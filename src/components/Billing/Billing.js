...
const getSmartDisplayUnit = (quantity, currentUnit) => {
  const baseUnit = getBaseUnit(currentUnit);
  ...
  if (baseUnit === 'g') {
    ...
    if (quantity >= 1000) {
      ...
      return 'ml'; // Small amounts in ml
    }
  }

  return currentUnit; // Keep original unit for count-based units
};
