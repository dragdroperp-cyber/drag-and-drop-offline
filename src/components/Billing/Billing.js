  ...
  return (
    <div className="fixed bottom-24 right-6 sm:bottom-10 sm:right-10 flex flex-col items-end gap-4 z-[100] pointer-events-none">
      ...
      <button
        ...
        className="group relative w-14 h-14 pointer-events-auto outline-none touch-manipulation"
      >
        <div className={`absolute inset-0 rounded-2xl shadow-2xl flex items-center justify-center transition-all duration-300 group-active:scale-90 border-2 border-white/20 ${isOpen ? 'bg-white rotate-45 shadow-none' : 'bg-black dark:bg-white shadow-black/20 dark:shadow-white/20'}`}>
