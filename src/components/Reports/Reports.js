  ...
  return (
    <div className="space-y-6 sm:space-y-8 fade-in-up">
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 auto-rows-[1fr]">
          {/* Net Sales */}
          ...
          <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
            ...
            <div className="mt-2 text-left">
              ...
              {(isLoading) ? (
                ...
                <p className="text-2xl font-semibold text-rose-600 dark:text-rose-400" title={formatCurrency(totalRefundsCombined)}>
          ...
          <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
            ...
            <div className="mt-2 text-left">
              ...
              {isLoading ? (
                ...
                <p className="text-2xl font-semibold text-blue-600 dark:text-blue-400" title={formatCurrency(totalDeliveryCharges)}>
          ...
          <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
            ...
            <div className="mt-2 text-left">
              ...
              {isLoading ? (
                ...
                <p className="text-2xl font-semibold text-rose-600 dark:text-rose-400" title={formatCurrency(totalCogs)}>
          ...
          {/* Gross Profit */}
          <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
            <div className={`absolute top-4 right-4 p-2.5 rounded-xl ${grossProfit >= 0 ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400' : 'bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400'}`}>
              <TrendingUp className="h-5 w-5" />
            </div>
            <div className="mt-2 text-left">
              ...
              {isLoading ? (
                ...
                <p className={`text-2xl font-semibold ${grossProfit >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'}`} title={formatCurrency(grossProfit)}>
          ...
          {/* Net Profit */}
          <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
            <div className={`absolute top-4 right-4 p-2.5 rounded-xl ${netProfit >= 0 ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400' : 'bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400'}`}>
              <TrendingUp className="h-5 w-5" />
            </div>
            <div className="mt-2 text-left">
              ...
              {isLoading ? (
                ...
                <p className={`text-2xl font-semibold ${netProfit >= 0 ? 'text-emerald-600' : 'text-rose-600'}`} title={formatCurrency(netProfit)}>
          ...
          <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
            ...
            <div className="mt-2 text-left">
              ...
              {isLoading ? (
                ...
                <p className="text-2xl font-semibold text-purple-600 dark:text-purple-400" title={formatCurrency(totalPendingProfit)}>
          ...
          {/* Profit Margin */}
          <div className="relative bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:shadow-md h-full">
            <div className="absolute top-4 right-4 p-2.5 rounded-xl bg-sky-50 dark:bg-sky-900/20 text-sky-600 dark:text-sky-400 text-center">
              <TrendingUp className="h-5 w-5" />
            </div>
            <div className="mt-2 text-left">
