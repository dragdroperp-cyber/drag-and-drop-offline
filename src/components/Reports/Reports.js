...
const Reports = () => {
  ...
  const exportReportsCSV = () => {
    try {
      ...
      const rows = [
        ['Sales Summary', 'Total Sales', formatCurrencySmart(totalSales, state.currencyFormat)],
        ['Sales Summary', 'Total Orders', totalOrders],
        ['Sales Summary', 'Net Profit', formatCurrencySmart(netProfit, state.currencyFormat)],
        ...
        ['Purchase Summary', 'Total Purchase Amount', formatCurrencySmart(totalPurchaseAmount, state.currencyFormat)],
        ['Purchase Summary', 'Pending Purchase Orders', pendingPurchaseOrders],
        ['Payment Summary', 'Cash Received', formatCurrencySmart(totalCashReceived, state.currencyFormat)],
        ['Payment Summary', 'Online Received', formatCurrencySmart(totalOnlineReceived, state.currencyFormat)],
        ['Payment Summary', 'Outstanding Due', formatCurrencySmart(totalOutstandingDue, state.currencyFormat)],
      ];
  ...
  const exportReportsPDF = async () => {
    try {
      ...
      const metrics = [
        { label: 'Total Sales', value: formatCurrencySmart(totalSales, state.currencyFormat) },
            ...
            <div className="p-6">
              ...
              <div className="mt-6 flex justify-end gap-4">
                <div className="bg-emerald-50 dark:bg-emerald-900/20 px-4 py-3 rounded-xl border border-emerald-100 dark:border-emerald-900/30">
                  <p className="text-xs text-emerald-600 dark:text-emerald-400 uppercase tracking-wide font-bold">Total Profit for Day</p>
                ...
                <div className="bg-indigo-50 dark:bg-indigo-900/20 px-4 py-3 rounded-xl border border-indigo-100 dark:border-indigo-900/30">
                  <p className="text-xs text-indigo-600 dark:text-indigo-400 uppercase tracking-wide font-bold">Total Sales for Day</p>
