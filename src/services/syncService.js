...
class SyncService {
  ...
  async _internalSyncAll(getStoreFunctions = null) {
    ...
    try {
      ...
      let syncOrder = ['categories', 'products', 'customers', 'suppliers', 'orders', 'transactions', 'refunds', 'expenses', 'customerTransactions', 'supplierTransactions', 'productBatches', 'purchaseOrders', 'planOrders', 'settings'];
  ...
  async retryFailedSyncs(getStoreFunctions = null) {
    ...
    const results = {};
    const syncOrder = ['categories', 'products', 'productBatches', 'customers', 'suppliers', 'orders', 'transactions', 'purchaseOrders', 'refunds', 'expenses', 'customerTransactions', 'supplierTransactions'];
