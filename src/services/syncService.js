...
class SyncService {
  ...
  async retryFailedSyncs(getStoreFunctions = null) {
    ...
    const results = {};
    const syncOrder = ['categories', 'products', 'productBatches', 'customers', 'suppliers', 'orders', 'transactions', 'purchaseOrders', 'refunds', 'expenses', 'customerTransactions', 'supplierTransactions', 'planOrders'];
