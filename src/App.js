...
const DProducts = lazy(() => import('./components/DProducts/DProducts'));
...
const ProductPerformance = lazy(() => import('./components/Reports/ProductPerformance'));
const ViewBill = lazy(() => import('./components/ViewBill/ViewBill'));
const Tutorials = lazy(() => import('./components/Tutorials/TutorialsPage'));
