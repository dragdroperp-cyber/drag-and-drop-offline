  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      if (!loadEssentialDataOnly) {
        ...
        [indexedDBCustomers, indexedDBOrders, indexedDBTransactions, indexedDBPurchaseOrders, indexedDBPlanOrders, indexedDBExpenses, indexedDBSuppliers, indexedDBSupplierTransactions] = await Promise.all(additionalPromises);
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        const {
          ...
          productBatches, categories, refunds, expenses, customerTransactions, planOrders, suppliers, supplierTransactions
        } = result.data;
