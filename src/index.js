...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    ...
    // Skip service worker on localhost unless explicitly forced
    if (isLocalhost) {
      // console.log('[SW] Service worker disabled on localhost to prevent caching issues in development.');
    ...
    if (isProduction) {
      ...
      // In development (excluding localhost), check if service worker file exists
