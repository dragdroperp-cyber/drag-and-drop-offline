...
export const backgroundSyncWithBackend = async (dispatch, ActionTypes, options = {}) => {
  ...
  try {
    ...
    const { customers, products, productBatches, orders, transactions, purchaseOrders, expenses, categories, customerTransactions, planOrders } = result.data.data;
    ...
    return {
      ...
      data: {
        ...
        planOrders: planOrders || [] // Return raw plan orders from API
      },
...
export const autoRefreshLatestData = async (dispatch, ActionTypes, lastFetchTimesArg) => {
  ...
  if (refreshPromise) {
    console.log('🔄 AUTO REFRESH: Reusing in-flight refresh promise...');
