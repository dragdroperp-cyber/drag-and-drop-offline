        ...
        case 'batch_create_from_po':
          ...
          try {
            ...
            if (batchResult.success) {
              ...
              const backendBatch = batchResult.data || batchResult.batch;
              ...
              if (backendBatch) {
                ...
                try {
                  await addItem(STORES.productBatches, mongoBatch);
            ...
            if (batchResult.success) {
              ...
              if (backendBatch) {
                ...
                try {
                  ...
                  // If addItem fails (e.g. duplicate key), it means it's likely already there.
                  // Just update the existing item to match backend
