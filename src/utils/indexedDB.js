...
const DB_VERSION = 31; // Force migration for customerTransactions store creation
...
export const initializeSyncTracking = async () => {
  const dataTypes = ['customers', 'products', 'categories', 'orders', 'transactions', 'purchaseOrders', 'refunds', 'plans', 'staff', 'expenses', 'customerTransactions'];
