...
export const formatCurrencySmart = (value, userPreference = 'compact') => {
  // Override to always use standard comma-separated format as per user request
  // "on whole website amount should be shown using comas like this if 1000 then 1,000"
