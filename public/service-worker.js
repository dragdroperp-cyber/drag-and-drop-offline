// Optimized Service Worker for Grocery ERP PWA
// Auto-versioned based on build timestamp for cache busting
const CACHE_VERSION = `v${Date.now()}`;
const CACHE_NAMES = {
  STATIC: `grocery-erp-static-${CACHE_VERSION}`,
  RUNTIME: `grocery-erp-runtime-${CACHE_VERSION}`,
  ASSETS: `grocery-erp-assets-${CACHE_VERSION}`
};
