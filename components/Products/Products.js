                              ...
                              <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                  ...
                                  <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                      <label className="text-xs text-gray-500 dark:text-slate-400 block mb-1">{getTranslation('wholesalePrice', state.currentLanguage)}</label>
                                      <input
                                        type="text"
                                        inputMode="decimal"
                                        value={editingBatchData.wholesalePrice}
                                  ...
                                  <div className="flex gap-2 pt-2">
                                    <button
                                      ...
                                      disabled={JSON.stringify({
                                        ...
                                        sellingUnitPrice: Number(batch.sellingUnitPrice || 0),
                                        wholesalePrice: Number(batch.wholesalePrice || 0),
                                        mfg: batch.mfg ? new Date(batch.mfg).toISOString().split('T')[0] : '',
                                        expiry: batch.expiry ? new Date(batch.expiry).toISOString().split('T')[0] : ''
                                      })}
